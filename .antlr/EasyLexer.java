...
public class EasyLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"INICIO", "FIN", "SI", "SINO", "MIENTRAS", "PARA", "RETORNAR", "LEER", 
			"IMPRIMIR", "SELECCIONAR", "CASO", "DEFECTO", "ROMPER", "CLASE", "SUPER", 
			"METODO", "FUNCION", "ENTERO", "FLOTANTE", "BOOLEANO", "CADENA", "VERDADERO", 
			"FALSO", "ID", "LITENTERO", "LITFLOTANTE", "LITERALCADENA", "IGUALIGUAL", 
			"MAYORIGUAL", "MENORIGUAL", "DIFERENTEDE", "IGUAL", "IGUAL_CASO", "Y", 
			"O", "MAYORQUE", "MENORQUE", "SUMA", "RESTA", "MULTIPLICACION", "DIVISION", 
			"LLAVEIZQ", "LLAVEDER", "PARIZQ", "PARDER", "CORCHETEIZQ", "CORCHETEDER", 
			"PUNTOYCOMA", "COMA", "PUNTO", "COMENTARIO", "ESPACIOS", "ERROR"
		};
	}
	...
	public EasyLexer(CharStream input) {
		super(input);
